...
export const MOCK_UNITS: Unit[] = [
    { id: 'U01', name: 'Piece', shortName: 'pc' },
    { id: 'U02', name: 'Kilogram', shortName: 'kg' },
    { id: 'U03', name: 'Liter', shortName: 'L' },
];
...
export const MOCK_USERS: User[] = [
    ...
    { id: 'USER002', name: 'Mike Manager', email: 'mike.manager@example.com', roleId: 'manager' },
